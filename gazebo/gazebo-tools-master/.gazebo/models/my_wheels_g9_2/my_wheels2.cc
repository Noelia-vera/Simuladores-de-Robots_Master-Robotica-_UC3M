...
namespace gazebo
{
    ...
    class MyWheels2 : public ModelPlugin
    {
    public:
        void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
        {
            ...
            finalPosition = ignition::math::Vector3d(16.5, 0.5, 0.0);
            initialHeading = model->WorldPose().Rot().Yaw();

            // Listen to the update event. This event is broadcast every simulation iteration.
            updateConnection = event::Events::ConnectWorldUpdateBegin(std::bind(&MyWheels2::OnUpdate, this));
        }
        ...
        void OnUpdate()
        {
         // Phase 1: Girar en su lugar hasta alcanzar el ángulo deseado
            ...
            std::cout << "anglediference2: " << angleDifference << " rad" << std::endl;

            if (fabs(angleDifference) > 0.01 and currentHeading > -0.45) {
                ...
                std::cout << "Initial Position2: " << initialPosition << std::endl;
                std::cout << "Final Position2: " << finalPosition << std::endl;
                std::cout << "Angle to Final2: " << angleToFinal << " radianes" << std::endl;
                std::cout << "Angle to Final2: " << angleToFinalDegrees << " degrees" << std::endl;
    ...
    GZ_REGISTER_MODEL_PLUGIN(MyWheels2)
}
